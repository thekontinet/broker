<x-ui.form action="{{ route('orders.store') }}" method="post" x-data="{trade: 'limit'}">
    ...
    <div class="flex items-center gap-2">
        <x-ui.primary-button name="type" value="buy" class="bg-green-500 hover:bg-green-700 active:bg-green-600 focus:bg-green-700 justify-between w-full">
            Buy
        ...
        <x-ui.primary-button name="type" value="sell" class="bg-red-500 hover:bg-red-700 active:bg-red-600 focus:bg-red-700 w-full justify-between">
            Sell
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" class="size-4">
