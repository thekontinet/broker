<x-page-layout>
    <section class="max-w-4xl py-12 mx-auto">
        <h1 class="text-center mb-4 font-semibold text-gray-800 text-4xl lg:text-5xl dark:text-neutral-200">
            About Us
        </h1>
        <p class="text-gray-600 text-justify dark:text-neutral-400">
        ...
        <h2 class="mt-4 text-lg text-gray-800 font-bold dark:text-white">
    ...
    <section class="max-w-4xl px-4 py-5 mx-auto">
        <!-- Grid -->
    ...
    <section class="relative bg-gradient-to-bl from-blue-100 via-transparent dark:from-blue-950 dark:via-transparent">
        <div class="mt-4 max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
            <h1 class="mb-4 text-center font-semibold text-gray-800 text-4xl lg:text-3xl dark:text-neutral-200">
                Our Vision
            </h1>
            <p class="max-w-3xl mx-auto text-gray-600 dark:text-neutral-400">
