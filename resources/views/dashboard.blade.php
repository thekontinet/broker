    ...
    <section class="grid lg:grid-cols-2 gap-4">
            ...
            @if($user->subscription()->exists())
                ...
                <div class="flex justify-between items-center">
                    <div>
                        ...
                        <p class="text-lg font-bold text-gray-800 dark:text-white">
                            {{money($user->subscription->wallet->balance + $user->subscription->profit)}}
                        </p>
                    </div>
                ...
                <p class="my-2 text-gray-500 dark:text-neutral-400">
                    <!-- Progress -->
                    <div>
                        <div class="inline-block mb-2 py-0.5 px-1.5 bg-blue-50 border border-blue-200 text-xs font-medium text-blue-600 rounded-lg dark:bg-blue-800/30 dark:border-blue-800 dark:text-blue-500" style="margin-left: {{$user->subscription->strength}}%; transform: translateX(-100%)">
                            Trading Signal: {{$user->subscription->strength}}%
                        </div>
