            ...
            <div class="p-4 md:p-5">
                <div class="flex justify-between">
                    <div class="text-lg font-bold text-gray-800 dark:text-white">
                        <p class="text-gray-400 dark:text-neutral-500">Average PnL:</p>
                        <h3 class="flex items-center gap-1">
                            {{ $trader->average_PnL }}
                        </h3>
                    </div>
                    <p class="mt-2 text-gray-500 dark:text-neutral-400">
                        ROI: <span class="text-lg font-bold text-gray-800 dark:text-white">{{ $trader->ROI }}</span>
                    </p>
                </div>
                <div class="mt-2 flex items-center justify-between gap-2">
                    ...
                    <x-ui.primary-button class="w-full justify-center">COPY</x-ui.primary-button>
                </div>
            </div>
        </div>
        @endforeach
